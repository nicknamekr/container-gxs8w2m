...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gxs8w2m.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gxs8w2m.containers.anotherwebservice.com/
...
```
git clone git@github.com:nicknamekr/container-gxs8w2m.git
cd container-gxs8w2m
```
...
```
docker attach container-gxs8w2m
```
